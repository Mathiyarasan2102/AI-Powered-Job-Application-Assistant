  ...
  return (
    <div className="flex items-center justify-center min-h-[90vh] relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        >
          <div className="mb-8">
            <h1 className="text-3xl font-display font-extrabold text-white mb-2">Initialize Account</h1>
            <p className="text-textMuted text-sm">Set up your agent to start crushing applications.</p>
          </div>
