...
- NO FABRICATION RULE (STRICT): NEVER invent, assume, round up, or exaggerate the candidate's experience duration. The summary must state the exact duration calculated from the candidate's experience startDate and endDate fields. If the internship ran from Oct 2025 to Jan 2026, that is 3 months — write "3 months", not "6 months" or "4+ months". Do not guess. Do not embellish. Use only what is explicitly in the candidate profile data.
